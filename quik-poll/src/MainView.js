...
//     useEffect(() => {
//         // Listen for 'start' event and update chart data and poll info accordingly
...
//     // Listen for 'poll-update' events and update chart data accordingly
//   socket.on("poll-update", (data) => {
//     // Update the chart data based on the received data
//     setChartData({
//       labels: Object.keys(data.options),
//       datasets: [
//         {
